...
public class InternalPackageXMLLexer extends Lexer {
    ...
    public final void mRULE_VERSION_TERMINAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4984:23: ( RULE_INT ( '.' RULE_INT )* )
            // InternalPackageXML.g:4984:25: RULE_INT ( '.' RULE_INT )*
            {
            mRULE_INT(); 
            // InternalPackageXML.g:4984:34: ( '.' RULE_INT )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalPackageXML.g:4984:35: '.' RULE_INT
            	    {
            	    match('.'); 
            	    mRULE_INT(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4986:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' | '.' | ',' | ':' | '/' )* )
            // InternalPackageXML.g:4986:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' | '.' | ',' | ':' | '/' )*
            {
            ...
            // InternalPackageXML.g:4986:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' | '.' | ',' | ':' | '/' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalPackageXML.g:4988:19: ( ( '0' .. '9' )+ )
            // InternalPackageXML.g:4988:21: ( '0' .. '9' )+
            {
            // InternalPackageXML.g:4988:21: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalPackageXML.g:4988:22: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4990:13: ( '\"' (~ ( '\"' ) )* '\"' )
            // InternalPackageXML.g:4990:15: '\"' (~ ( '\"' ) )* '\"'
            {
            match('\"'); 
            // InternalPackageXML.g:4990:19: (~ ( '\"' ) )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4992:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPackageXML.g:4992:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPackageXML.g:4992:24: ( options {greedy=false; } : . )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4994:17: ( '<!--' (~ ( ( '\\n' | '\\r' ) ) )* '-->' ( ( '\\r' )? '\\n' )? )
            // InternalPackageXML.g:4994:19: '<!--' (~ ( ( '\\n' | '\\r' ) ) )* '-->' ( ( '\\r' )? '\\n' )?
            {
            match("<!--"); 

            // InternalPackageXML.g:4994:26: (~ ( ( '\\n' | '\\r' ) ) )*
            loop6:
            do {
                int alt6=2;
            ...
            // InternalPackageXML.g:4994:48: ( ( '\\r' )? '\\n' )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalPackageXML.g:4994:49: ( '\\r' )? '\\n'
                    {
                    // InternalPackageXML.g:4994:49: ( '\\r' )?
                    int alt7=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4996:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPackageXML.g:4996:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPackageXML.g:4996:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPackageXML.g:4998:16: ( . )
            // InternalPackageXML.g:4998:18: .
            {
            matchAny(); 
